...
/**
 * Every resume, kept current from the `resumesChanged` push so the board chip, the item
 * detail row, the apply modal and Settings never disagree about which one is the default.
 */
