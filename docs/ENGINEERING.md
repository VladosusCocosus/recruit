# Jobbox — engineering notes

How Jobbox is built, what each agent run can reach, and what v1 deliberately does not do.
For what the app is and who it is for, see the [README](../README.md).
